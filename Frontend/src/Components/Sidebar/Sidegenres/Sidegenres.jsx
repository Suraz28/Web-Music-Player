    ...
    return (
        <div className='sidegenres'>
            <div className='sidegenresdiv'>
                ...
                <img src='./public/Artists/Images/Boosterimage.jpg' style={{ width: '100%', height: '30vh', objectFit: 'cover', borderRadius: "10px" }}/>
                <div className="genreList">
                    {artists.map((artist, id) => (
                        <div className='genresitemlists' key={artist.id} onClick={() => handleSongSelect(artist)}>
