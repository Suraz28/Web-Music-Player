...
const Genrebhajan = () => {
    ...
    const fetchArtists = async () => {
        const response = await fetch("http://localhost:3000/bhajan");
        if (!response.ok) {
    ...
    return (
        <div className='sidegenres'>
            <div className='sidegenresdiv'>
                ...
                <img src='./public/Artists/Images/Bhajanimage.png' style={{ width: '100%', height: '30vh', objectFit: 'cover', borderRadius: "10px" }}/>
