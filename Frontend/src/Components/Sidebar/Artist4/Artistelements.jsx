...
const Artistelements = () => {
    ...
    const fetchArtists = async () => {
        const response = await fetch("http://localhost:3000/TheElements");
        if (!response.ok) {
    ...
    return (
        <div className='sidegenres'>
            <div className='sidegenresdiv'>
                ...
                <img src='./public/Artists/Images/The Elements.jpg' style={{ width: '100%', height: '30vh', objectFit: 'cover', borderRadius: "10px" }}/>
