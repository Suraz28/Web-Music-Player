    ...
    return (
        <div className='sidegenres'>
            <div className='sidegenresdiv'>
                ...
                <img src='./public/Artists/Images/Happyimage.png' style={{ width: '100%', height: '30vh', objectFit: 'cover', borderRadius: "10px" }}/>
